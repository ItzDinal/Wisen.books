import { books } from '../data/dummyData.js';
...
const shop = (req, res) => render(res, 'pages/shop', 'Wisen Book Mart | Shop', { books });
...
export default { home, shop, bookDetails, cart, checkout, blog, contact };